...
export const CartIcon: React.FC<{ className?: string }> = ({ className }) => (
  <div className="relative">
    ...
    <span className="absolute -top-2 -right-2 bg-[#FF715B] text-white text-xs rounded-full h-4 w-4 flex items-center justify-center">0</span>
  </div>
);
...
export const MoneyGuaranteeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 8l3 5m0 0l3-5m-3 5v4m0 0H9m3 0h3m-9 5a9 9 0 1118 0 9 9 0 01-18 0z" />
    </svg>
);
